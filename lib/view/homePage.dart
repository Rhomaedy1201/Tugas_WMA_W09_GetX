import 'package:add_cart_using_getx/controller/puchase.dart';
...
class HomePage extends StatelessWidget {
  ...
  DemoController cart = Get.put(DemoController());
              ...
              child: Row(
                ...
                children: [
                  ...
                  GetX<DemoController>(builder: (controller) {
                    return Text(
                      'Total Harga Rp${controller.totalAmount}',
                      style: TextStyle(
                          color: Colors.white,
              ...
              itemBuilder: (context, index) => Padding(
                ...
                child: Card(
                  ...
                  child: Column(
                    children: [
                      Image.network(
                        controller.products[index].producImage,
                        fit: BoxFit.cover,
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(
                                onPressed: () =>
                                    cart.addCart(controller.products[index]),
                                child: Text(
                                  'Shop Now',
                                  style: TextStyle(
                                      fontWeight: FontWeight.normal,
